...
DefProp([].Base, "Shape2", {Get: GetArrShape2})
...
DefProp("".Base, "RemovePrefix", {Get: StrRemovePrefix})
DefProp("".Base, "RemoveSuffix", {Get: StrRemoveSuffix})
...
StrDecode2(this, Encoding := -1)
{    if Encoding == -1
    ...
    else if Encoding = "Unicode_Escape" || Encoding = "Unicode"
    {
        ...
        Loop Lst_this.Length - 1
        {
            ...
            Unicode_Base := String(Integer("0x" Unicode_this))
...
StringRange(this)
{
    ...
    Lst_this[1] := Lst_this[1] ? Integer(Lst_this[1]) : 1
    Lst_this[2] := Lst_this[2] ? Integer(Lst_this[2]) : -1
...
StrRemovePrefix(this)
{
    Return StrRemovePrefix2
}

StrRemovePrefix2(this, Arg := "")
{
    if !Arg
        Return LTrim(this)
    Return LTrim(this, Arg)
}

StrRemoveSuffix(this)
{
    Return StrRemoveSuffix2
}

StrRemoveSuffix2(this, Arg := "")
{
    if !Arg
        Return RTrim(this)
    Return RTrim(this, Arg)
}